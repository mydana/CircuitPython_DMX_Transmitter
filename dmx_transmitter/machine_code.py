...
machine_code = (
    ...
    # index = 2: Two desired sideset_pins.
    memoryview(
        b"\x30\x68\x41\x08\x03\xa8\x30\x68\x44\x08\x30\x68\x0b\xb8\x47\x18"
        b"\x50\x78\xe0\x98\x03\xaa\x27\xe8\x01\x69\x42\xa8\x4c\x08\x0b\xa8"
        b"\x28\x68\x51\x08\x89\x08\xe0\x88\x03\xaa\x27\xe8\x01\x69\x42\xa8"
        b"\x56\x08\x0b\xa8\x28\x68\x20\x08\x5c\x08\xa0\x80"
    ).cast("H"),
    # index = -2: Two desired logically-inverted sideset_pins.
    memoryview(
        b"\x30\x70\x41\x10\x03\xb0\x30\x70\x44\x10\x30\x70\x0b\xa0\x47\x00"
        b"\x50\x60\xe0\x80\x03\xb2\x27\xf0\x01\x71\x42\xb0\x4c\x10\x0b\xb0"
        b"\x28\x70\x51\x10\x89\x10\xe0\x90\x03\xb2\x27\xf0\x01\x71\x42\xb0"
        b"\x56\x10\x0b\xb0\x28\x70\x20\x10\x5c\x10\xa0\x98"
    ).cast("H"),
    # index = -1: One desired logically-inverted sideset_pins.
    memoryview(
        b"\x30\x60\x41\x00\x03\xa0\x30\x60\x44\x00\x30\x60\x0b\xa0\x47\x00"
        b"\x50\x60\xe0\x80\x03\xa2\x27\xe0\x01\x61\x42\xa0\x4c\x00\x0b\xa0"
        b"\x28\x60\x51\x00\x89\x00\xe0\x80\x03\xa2\x27\xe0\x01\x61\x42\xa0"
        b"\x56\x00\x0b\xa0\x28\x60\x20\x00\x5c\x00\xa0\x90"
    ).cast("H"),
)
