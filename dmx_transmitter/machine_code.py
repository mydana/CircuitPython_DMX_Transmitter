...
The text-separated-values source file is: assembly_code/assembly_code.txt.csv
...
machine_code = (
    ...
    memoryview(
        ...
        b"\x50\x60\xe0\x80\x03\xa2\x27\xe0\x01\x62\x4c\x00\x0b\xa0\x28\x60"
        b"\x50\x00\x89\x00\xe0\x80\x03\xa2\x27\xe0\x01\x62\x55\x00\x0b\xa0"
        b"\x28\x60\x20\x00\x5a\x00\xa0\x80"
    ).cast("H"),
    # index = 1: One desired sideset_pins.
    memoryview(
        b"\x30\x70\x41\x10\x03\xb0\x30\x70\x44\x10\x30\x70\x0b\xb0\x47\x10"
        b"\x50\x70\xe0\x90\x03\xb2\x27\xf0\x01\x72\x4c\x10\x0b\xb0\x28\x70"
        b"\x50\x10\x89\x10\xe0\x90\x03\xb2\x27\xf0\x01\x72\x55\x10\x0b\xb0"
        b"\x28\x70\x20\x10\x5a\x10\xa0\x80"
    ).cast("H"),
    # index = 2: Two desired sideset_pins.
    memoryview(
        b"\x30\x68\x41\x08\x03\xa8\x30\x68\x44\x08\x30\x68\x0b\xb8\x47\x18"
        b"\x50\x78\xe0\x98\x03\xaa\x27\xe8\x01\x6a\x4c\x08\x0b\xa8\x28\x68"
        b"\x50\x08\x89\x08\xe0\x88\x03\xaa\x27\xe8\x01\x6a\x55\x08\x0b\xa8"
        b"\x28\x68\x20\x08\x5a\x08\xa0\x80"
    ).cast("H"),
    # index = -2: Two desired logically-inverted sideset_pins.
    memoryview(
        b"\x30\x70\x41\x10\x03\xb0\x30\x70\x44\x10\x30\x70\x0b\xa0\x47\x00"
        b"\x50\x60\xe0\x80\x03\xb2\x27\xf0\x01\x72\x4c\x10\x0b\xb0\x28\x70"
        b"\x50\x10\x89\x10\xe0\x90\x03\xb2\x27\xf0\x01\x72\x55\x10\x0b\xb0"
        b"\x28\x70\x20\x10\x5a\x10\xa0\x98"
    ).cast("H"),
    ...
    memoryview(
        ...
        b"\x50\x60\xe0\x80\x03\xa2\x27\xe0\x01\x62\x4c\x00\x0b\xa0\x28\x60"
        b"\x50\x00\x89\x00\xe0\x80\x03\xa2\x27\xe0\x01\x62\x55\x00\x0b\xa0"
        b"\x28\x60\x20\x00\x5a\x00\xa0\x90"
    ).cast("H"),
)
